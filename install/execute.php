...
?>";
		...
		case 4:
			...
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (1, 'general_communityname', '{$communityInfo['community_name']}');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (2, 'general_communityurl', '{$communityInfo['community_url']}');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (3, 'general_websitename', 'My Website');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (4, 'general_websiteurl', 'http://');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (5, 'general_communitylogo', 'logo.png');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (6, 'general_sidebar_online', 'true');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (7, 'general_sidebar_stats', 'true');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (8, 'date_long_format', 'd M Y, H:i');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (9, 'date_default_offset', '-3');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (10, 'thread_posts_hot', '15');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (11, 'seo_description', 'An Addictive Services product.');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (12, 'seo_keywords', 'addictive, community, board');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (13, 'date_short_format', 'd M Y');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (14, 'general_session_expiration', '900');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (15, 'thread_posts_per_page', '10');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (16, 'thread_best_answer_all_pages', 'false');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (17, 'thread_obsolete', 'false');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (18, 'thread_obsolete_value', '60');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (19, 'emoticon_default_set', 'default');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (20, 'thread_allow_emoticons', 'true');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (21, 'general_allow_guest_post', 'false');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (22, 'general_offline', 'false');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (23, 'general_disable_registrations', 'false');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (24, 'general_bread_separator', '>');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (25, 'member_pm_enable', 'true');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (26, 'member_pm_storage', '100');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (27, 'general_calendar_enable', 'true');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (28, 'general_email_smtp', '');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (29, 'general_email_username', '');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (30, 'general_email_password', '');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (31, 'general_email_port', '587');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (32, 'general_email_authentication', 'true');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (33, 'general_email_auth_method', 'tls');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (34, 'general_security_validation', 'false');";
			$sql[] = "INSERT INTO `c_config` (`id`, `index`, `value`) VALUES (35, 'general_warning_max', '5');";
