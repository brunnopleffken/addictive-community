...
<div class="box">
	...
	<form class="fright">
		<input type="button" class="cancel" onclick="window.location.href='index.php?module=calendar&view=addevent'" value="Delete Selected Messages">
...
<table class="tableList">
	...
	<tr>
		...
		<td class="min"><input type="checkbox" name="pm[]" value="<?php __($pm['pm_id']) ?>"></td>
	</tr>
	<?php
			endforeach;
		else:
