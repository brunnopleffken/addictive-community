<?php
	...
	$t["R_RETYPE_PASSWD"] = "Confirm Password";
	...
	$t["R_ERROR_1"] = "All fields are required. If they're not filled, the registration can't continue.";
	$t["R_ERROR_2"] = "Typed passwords don't match.";
	$t["R_ERROR_3"] = "Username must be between 3 and 20 characters.";
	$t["R_ERROR_4"] = "Username or e-mail address already exists.";
	$t["R_ERROR_5"] = "The entered CAPTCHA key doesn't match.";
