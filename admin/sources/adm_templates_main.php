	...
	<div id="content">
		...
		<div class="grid-row">
			...
			<table class="table-list">
				...
				<tr><td><a href="main.php?act=templates&p=manager"><b>Template Manager</b></a><br>Manage template sets: edit HTML and CSS sources, template name and folders, etc.</td></tr>
